...
class TrustSignalAnalyzer:
    def analyze(self, text: str) -> Dict:
        ...
        risk_reversal_hits = len(re.findall(r"\bguarantee|cancel anytime|refund\b", lower))
        score = min(100, testimonial_hits * 20 + social_proof_hits * 10 + risk_reversal_hits * 20)
        return {
            "score": score,
